package net.chamman.shoppingmall_admin.infra.sms.impl;
...
import net.chamman.shoppingmall_admin.infra.sms.dto.NaverSmsRecipientRequestDto;
import net.chamman.shoppingmall_admin.infra.sms.dto.NaverSmsRequestDto;
...
public class NaverSmsSenderImpl implements SmsSender{
	 ...
	 * @param message
	 * 
	 * @throws SmsSendException{@link #SMS_SEND_FAIL} {@link NaverSmsSenderImpl#sendSms}
	 * 
	...
	public int sendSms(String recipientPhone, String message) {
		...
		String naverSignature = naverSignatureGenerator.getNaverSignature("POST", smsSendPath, time);
